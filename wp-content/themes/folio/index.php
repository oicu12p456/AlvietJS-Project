        ...
        <div class="overlay">
            <div class="container padding-top-large">
                ...
                <div class="row margin-bottom-medium">
                    ...
                    <div class="col-md-5">
                        <img src="http://localhost/hanh/wp-content/themes/folio/img/about-side-side.png" alt="About Us Big Image" class="center-block img-responsive">
                    </div>
                    <div class="clearfix"></div>
                </div>
                ...
                <div class="row margin-top-large">
                    ...
                    <div class="col-md-4">
                        <img src="http://localhost/hanh/wp-content/themes/folio/img/case-studdy-people.png" class="center-block img-responsive" alt="Case Study">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="our-skills" class="our-skills">
        <div class="container padding-top-large">
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <img src="http://localhost/hanh/wp-content/themes/folio/img/skill-bg.jpg" class="center-block img-responsive" alt="Our Skills are excellent">
                </div>
                <div class="clearfix"></div>
            </div> <!-- *** end row *** -->
        </div> <!-- *** end container *** -->
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 margin-bottom-large">
                    ...
                    <div class="team-member center-block wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay="1s">
                        <img src="http://localhost/hanh/wp-content/themes/folio/img/team/team-member-1.jpg" class="img-responsive" alt="Jack Smith">
                                ...
                                <div class="modal-body member-info">
                                    <div class="row">
                                        <div class="col-md-5 col-sm-5">
                                            <figure>
                                                <img src="http://localhost/hanh/wp-content/themes/folio/img/team/big/team-member-1.jpg" alt="Jack Smith">
                                            </figure>
                                        </div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 margin-bottom-large">
                    ...
                    <div class="team-member center-block wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="1s">
                        <img src="http://localhost/hanh/wp-content/themes/folio/img/team/team-member-2.jpg" class="img-responsive" alt="John Doe">
                        <div class="team-overlay text-center">
                            <div class="info">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body member-info">
                                    <div class="row">
                                        <div class="col-md-5 col-sm-5">
                                            <figure>
                                                <img src="http://localhost/hanh/wp-content/themes/folio/img/team/big/team-member-2.jpg" alt="John Doe">
                                            </figure>
                                        </div>
                                        <div class="col-md-7 col-sm-7">
                                            <div class="description">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 margin-bottom-large">
                    <!-- ***** Team member-1 ***** -->
                    <div class="team-member center-block wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="1s">
                        <img src="http://localhost/hanh/wp-content/themes/folio/img/team/team-member-3.jpg" class="img-responsive" alt="Jack Sparrow">
                        <div class="team-overlay text-center">
                            <div class="info">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body member-info">
                                    <div class="row">
                                        <div class="col-md-5 col-sm-5">
                                            <figure>
                                                <img src="http://localhost/hanh/wp-content/themes/folio/img/team/big/team-member-3.jpg" alt="">
                                            </figure>
                                        </div>
                                        <div class="col-md-7 col-sm-7">
                                            <div class="description">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 margin-bottom-large">
                    ...
                    <div class="team-member center-block wow fadeInRight" data-wow-duration="1.5s" data-wow-delay="1s">
                        <img src="http://localhost/hanh/wp-content/themes/folio/img/team/team-member-4.jpg" class="img-responsive" alt="George Wyne">
                        <div class="team-overlay text-center">
                            <div class="info">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body member-info">
                                    <div class="row">
                                        <div class="col-md-5 col-sm-5">
                                            <figure>
                                                <img src="http://localhost/hanh/wp-content/themes/folio/img/team/big/team-member-4.jpg" alt="">
                                            </figure>
                                        </div>
                                        <div class="col-md-7 col-sm-7">
                                            <div class="description">
                    ...
                    <div id="testimonial-carousel" class="owl-carousel owl-theme testimonial-carousel">
                        ...
                        <div class="item margin-bottom-small"> <!-- ITEM START -->
                            ...
                            <div class="client margin-top-medium clearfix">
                                <img src="http://localhost/hanh/wp-content/themes/folio/img/testimonial/testimonial-1.jpg" height="50" width="50" alt="Client Image">
                        ...
                        <div class="item"> <!-- ITEM START -->
                            ...
                            <div class="client margin-top-medium">
                                <img src="http://localhost/hanh/wp-content/themes/folio/img/testimonial/testimonial-2.jpg" alt="Client Image" class="grayscale">
                                <ul class="client-info main-color">
                                    <li>John Doe</li>
                                    <li>Co-Founder, Envato</li>
                                </ul>
                        ...
                        <div class="item"> <!-- ITEM START -->
                            <p>This is Photoshop's version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit..</p>
                            <div class="client margin-top-medium">
                                <img src="http://localhost/hanh/wp-content/themes/folio/img/testimonial/testimonial-1.jpg" alt="Client Image" class="grayscale">
                                <ul class="client-info main-color">
                                    <li>John Doe</li>
                                    <li>Co-Founder, Envato</li>
                                </ul>
    ...
    <section id="portfolio" class="portfolio padding-large text-center">
        ...
        <div class="portfolio-wrapper margin-bottom-medium">
            ...
            <div class="portfolio-item print">
                <div class="portfolio">
                    <a href="http://localhost/hanh/wp-content/themes/folio/img/portfolio/portfolio-1.jpg" data-lightbox-gallery="portfolio">
                        <img src="http://localhost/hanh/wp-content/themes/folio/img/portfolio/portfolio-1.jpg" alt="Portfolio 1"/><!-- END PORTFOLIO IMAGE -->
            ...
            <div class="portfolio-item photography">
               <div class="portfolio">
                  <a href="http://localhost/hanh/wp-content/themes/folio/img/portfolio/portfolio-2.jpg" data-lightbox-gallery="portfolio">
                    <img src="http://localhost/hanh/wp-content/themes/folio/img/portfolio/portfolio-2.jpg" alt="Portfolio 2"/><!-- END PORTFOLIO IMAGE -->
                    <div class="portfolio-overlay hvr-rectangle-out">
                        <h2 class="margin-bottom-small">
                            Cute
            ...
            <div class="portfolio-item photography">
               <div class="portfolio">
                  <a href="http://localhost/hanh/wp-content/themes/folio/img/portfolio/portfolio-3.jpg" data-lightbox-gallery="portfolio">
                    <img src="http://localhost/hanh/wp-content/themes/folio/img/portfolio/portfolio-3.jpg" alt="Portfolio 1"/><!-- END PORTFOLIO IMAGE -->
                    <div class="portfolio-overlay hvr-rectangle-out">
                        <h2 class="margin-bottom-small">
                            Our
                            <strong class="white-color bold-text">Portfolios</strong>
            ...
            <div class="portfolio-item print">
               <div class="portfolio">
                  <a href="http://localhost/hanh/wp-content/themes/folio/img/portfolio/portfolio-4.jpg" data-lightbox-gallery="portfolio">
                    <img src="http://localhost/hanh/wp-content/themes/folio/img/portfolio/portfolio-4.jpg" alt="Portfolio 1"/><!-- END PORTFOLIO IMAGE -->
                    <div class="portfolio-overlay hvr-rectangle-out">
                        <h2 class="margin-bottom-small">
                            Our
                            <strong class="white-color bold-text">Portfolios</strong>
            ...
            <div class="portfolio-item ui">
               <div class="portfolio">
                  <a href="http://localhost/hanh/wp-content/themes/folio/img/portfolio/portfolio-5.jpg" data-lightbox-gallery="portfolio">
                    <img src="http://localhost/hanh/wp-content/themes/folio/img/portfolio/portfolio-5.jpg" alt="Portfolio 1"/><!-- END PORTFOLIO IMAGE -->
                    <div class="portfolio-overlay hvr-rectangle-out">
                        <h2 class="margin-bottom-small">
                            Our
                            <strong class="white-color bold-text">Portfolios</strong>
            ...
            <div class="portfolio-item web-design">
               <div class="portfolio">
                  <a href="http://localhost/hanh/wp-content/themes/folio/img/portfolio/portfolio-6.jpg" data-lightbox-gallery="portfolio">
                    <img src="http://localhost/hanh/wp-content/themes/folio/img/portfolio/portfolio-6.jpg" alt="Portfolio 1"/><!-- END PORTFOLIO IMAGE -->
                    <div class="portfolio-overlay hvr-rectangle-out">
                        <h2 class="margin-bottom-small">
                            Our
                            <strong class="white-color bold-text">Portfolios</strong>
            ...
            <div class="portfolio-item web-design">
               <div class="portfolio">
                  <a href="http://localhost/hanh/wp-content/themes/folio/img/portfolio/portfolio-7.jpg" data-lightbox-gallery="portfolio">
                    <img src="http://localhost/hanh/wp-content/themes/folio/img/portfolio/portfolio-7.jpg" alt="Portfolio 1"/><!-- END PORTFOLIO IMAGE -->
                    <div class="portfolio-overlay hvr-rectangle-out">
                        <h2 class="margin-bottom-small">
                            Our
                            <strong class="white-color bold-text">Portfolios</strong>
            ...
            <div class="portfolio-item icon">
               <div class="portfolio">
                  <a href="http://localhost/hanh/wp-content/themes/folio/img/portfolio/portfolio-8.jpg" data-lightbox-gallery="portfolio">
                    <img src="http://localhost/hanh/wp-content/themes/folio/img/portfolio/portfolio-8.jpg" alt="Portfolio 1"/><!-- END PORTFOLIO IMAGE -->
                    <div class="portfolio-overlay hvr-rectangle-out">
                        <h2 class="margin-bottom-small">
                            Our
                            <strong class="white-color bold-text">Portfolios</strong>
