...
<section class="service-section sec-padding roundded-box">
		...
		<div class="row">
			...
			<div class="col-md-<?php echo esc_attr( $column_class ); ?> col-sm-6 col-xs-12">
				<div class="single-service text-center">
					...
					<a href="<?php echo esc_url(digitalmedia_set($services_meta , 'ext_url'));?>"><?php esc_html_e('Read More', 'digitalmedia');?></a>
				</div>
			</div>
		<?php endwhile;?>		
		</div>
