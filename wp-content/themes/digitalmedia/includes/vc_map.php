...
//Services
digitalmedia_vc_map( array(
			"name" => esc_html__("bbPress Forums", 'digitalmedia'),
			"base" => "bbp-forum-index",
			"class" => "",
			"category" => esc_html__('Jollyall', 'digitalmedia'),
			"icon" => 'faqs' ,
			"params" => array(				
				array(
				   "type" => "textfield",
				   "holder" => "div",
				   "class" => "",
				   "heading" => esc_html__("Forum", 'digitalmedia'),
				   "param_name" => "forum",
				   "description" => ''
				),
...
function vc_theme_vc_row($atts, $content = null) {
   ...
   extract(shortcode_atts(array(
	...
	//$boxed = digitalmedia_set( _WSH()->option(), 'boxed_layout' );
...
$param = array(
  ...
  "holder" => "div",
  "class" => "",
  "heading" => esc_html__("Container", 'digitalmedia'),
  "param_name" => "container",
  "value" => array('Center Page'=>true),
  "description" => esc_html__("Choose whether you want to add a container before row or not.", 'digitalmedia')
);
